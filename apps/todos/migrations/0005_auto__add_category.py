...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('todos_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('todos', ['Category'])
        ...
        db.create_table('todos_todo_categories', (
            ...
            ('category', models.ForeignKey(orm['todos.category'], null=False))
        ))
        db.create_unique('todos_todo_categories', ['todo_id', 'category_id'])


    def backwards(self, orm):
        
        # Deleting model 'Category'
        db.delete_table('todos_category')
    ...
    models = {
        ...
        'milestones.milestone': {
            ...
            'due': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 1, 31, 15, 38, 23, 267832)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'todos.todo': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['todos.Category']", 'symmetrical': 'False'}),
