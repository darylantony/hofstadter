...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Timing.stop'
        db.alter_column('todos_timing', 'stop', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Timing.stop'
        db.alter_column('todos_timing', 'stop', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 1, 30, 22, 46, 48, 411488)))
    ...
    models = {
        ...
        'milestones.milestone': {
            ...
            'due': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 1, 30, 22, 46, 48, 424197)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
