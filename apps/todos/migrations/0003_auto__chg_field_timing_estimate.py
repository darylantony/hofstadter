...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Timing.estimate'
        db.alter_column('todos_timing', 'estimate', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Timing.estimate'
        db.alter_column('todos_timing', 'estimate', self.gf('django.db.models.fields.FloatField')(default=1))
    ...
    models = {
        ...
        'milestones.milestone': {
            ...
            'due': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 1, 30, 22, 51, 44, 706100)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'todos.timing': {
            ...
            'estimate': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
