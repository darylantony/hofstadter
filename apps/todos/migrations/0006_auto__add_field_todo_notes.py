...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ToDo.notes'
        db.add_column('todos_todo', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ToDo.notes'
        db.delete_column('todos_todo', 'notes')
    ...
    models = {
        ...
        'milestones.milestone': {
            ...
            'due': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2011, 1, 31, 16, 19, 53, 57475)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
